...
export default function Sites() {
  ...
  const getActiveTab = () => {
    ...
    if (currentPath.includes("/departments")) return "department";
  ...
  const [sites, setSites] = useState([
    ...
    },
    {
      ...
      contactEmail: "sanjay@company.com",
      status: "active",
      siteManager: "Rohit Verma",
      totalEmployees: 65,
      siteArea: "2800 sq ft",
      establishedDate: "2019-11-25",
    },
    {
      id: 5,
      siteName: "Training Center",
      siteCode: "TC005",
      address: "654 Learning Hub",
      city: "Chennai",
      country: "India",
      postalCode: "600001",
      contactPerson: "Anjali Reddy",
      contactPhone: "+91 9876543214",
      contactEmail: "anjali@company.com",
      status: "inactive",
      siteManager: "Karthik Nair",
      totalEmployees: 0,
      siteArea: "1800 sq ft",
    ...
    },
    {
      ...
      contactEmail: "manoj@company.com",
      status: "active",
      siteManager: "Suresh Iyer",
      totalEmployees: 30,
      siteArea: "8000 sq ft",
      establishedDate: "2020-07-30",
    },
    {
      id: 7,
      siteName: "R&D Lab",
      siteCode: "RD007",
      address: "147 Science Street",
      city: "Bangalore",
      country: "India",
      postalCode: "560066",
      contactPerson: "Dr. Ravi Menon",
      contactPhone: "+91 9876543216",
      contactEmail: "ravi@company.com",
      status: "active",
      siteManager: "Dr. Lakshmi Rao",
      totalEmployees: 25,
      siteArea: "3200 sq ft",
    ...
    },
    {
      ...
      siteCode: "RO008",
      address: "258 Digital Avenue",
      city: "Kolkata",
      country: "India",
      postalCode: "700001",
      contactPerson: "Sunita Das",
      contactPhone: "+91 9876543217",
      contactEmail: "sunita@company.com",
      status: "planned",
      siteManager: "Bimal Choudhury",
      totalEmployees: 0,
      siteArea: "1500 sq ft",
  ...
  const filteredSites = sites.filter((site) => {
    ...
    const matchesLocation =
      filterLocation === "all" || site.city === filterLocation;
    return matchesSearch && matchesStatus && matchesLocation;
  });

  // Calculate statistics
  const activeSites = sites.filter((s) => s.status === "active").length;
  const totalEmployees = sites.reduce(
    (sum, site) => sum + parseInt(site.totalEmployees),
    0
  );
            ...
            >
              <div>
                ...
                <p style={{ fontSize: "16px", color: "#6b7280" }}>
                  Manage company sites, locations, and facilities
                </p>
              </div>
              ...
              {modalMode === "view" ? (
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Postal Code: {selectedSite.postalCode}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      {formatDate(selectedSite.establishedDate)}
                    </div>
                  </div>
                </div>
              ) : (
